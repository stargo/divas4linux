...
#define	DBG_DECL(func)	extern void __cdecl myDbgPrint_##func (char *, ...) ;
...
DBG_DECL(MXLOG)
DBG_DECL(FTL_MXLOG)
extern void __cdecl myDbgPrint_EVL (long, ...) ;
...
typedef void (__cdecl * DbgEnd) (pDbgHandle) ;
typedef void (__cdecl * DbgLog) (unsigned short, int, char *, va_list) ;
typedef void (__cdecl * DbgOld) (unsigned short, char *, va_list) ;
typedef void (__cdecl * DbgEv)  (unsigned short, unsigned long, va_list) ;
typedef void (__cdecl * DbgIrq) (unsigned short, int, char *, va_list) ;
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            void (__cdecl * MaskChangedNotify) (void *pContext);
...
void __cdecl xdi_dbg_xlog (char* x, ...);
void __cdecl xdi_dbg_xlogH (_DbgHandle_ *pDebugHandle, char* x, ...);
