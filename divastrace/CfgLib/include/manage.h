...
#ifndef __DIVA_DRV_MANAGE_H__
#define __DIVA_DRV_MANAGE_H__
...
#define MANAGEMENT_ENTITY_FEATURE_NOHIDE    0x01 /* do not hide variables with MI_HIDE attribute   */
...
struct man_info_s 
{
  const char *name;    /* variable's name as AsciiZ string   */
...
#define MI_ENUM_MASK 0x0c
                        /* Directory supports CMD_ALTNEXTNODE       */
                        /* command */
#define MI_GETALTNODE 0x10
...
#define CMD_ALTNEXTNODE 0x07  /* Get pointer to alternative node    */
