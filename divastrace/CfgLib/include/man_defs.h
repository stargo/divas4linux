...
#define MI_ESC          0x04  /* Special purpose escape variable    */
                              /* used for ind_count (chained indications) */
#define MI_HIDE         0x08  /* Variable is hidden                 */
#if defined(QPRI)
#define MI_REMOTE       0x10  /* Variable apply to remote management interface */
#else
#define MI_REMOTE       0x00
#endif
