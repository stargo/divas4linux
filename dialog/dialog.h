 ...
 */
#ifdef HAVE_NCURSES
extern void _dialog_create_rc (const char *filename);
extern int _dialog_parse_rc (void);
#endif


void dialog_init (void);
void dialog_end (void);
void _dialog_title (WINDOW *win, int width, const char *title);
WINDOW *_dialog_newwin (int height, int width, int y, int x, int boxflag);
void _dialog_attr_clear (WINDOW * win, int height, int width, chtype attr);
void dialog_clear (void);
void _dialog_print_autowrap (WINDOW * win, const char *prompt,
		int width, int y, int x);
void _dialog_print_button (WINDOW * win, const char *label, int y, int x,
		int selected);
